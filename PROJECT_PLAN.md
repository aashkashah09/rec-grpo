...
```
specialist-router/
├── CLAUDE.md                  # Claude Code briefing (conventions, guardrails)
...
### Phase 0 — Scaffolding (Claude Code; ~1 session)
...
### Phase 1 — Environment, tasks, verifier (Claude Code; ~2 sessions)
...
### Phase 2 — Router + serving + logging + OPE (Claude Code; ~3 sessions) ⭐ standalone milestone
...
### Phase 3 — GRPO specialist training (You + Claude Code; ~2 sessions + GPU time)
- Claude Code writes: prompt/format spec, reward fn (verifier-backed, plus small format
...
### Phase 4 — Integration: specialist into the cascade (Claude Code; ~1 session)
...
### Phase 5 — Report, polish, demo (You + Claude Code; ~2 sessions)
